...
interface PremiumSliderProps<T extends SliderItem> {
  items: T[];
  renderItem: (item: T, index: number) => ReactNode;
  coverflow?: boolean;
}

export default function PremiumSlider<T extends SliderItem>({ items, renderItem, coverflow = false }: PremiumSliderProps<T>) {
  return (
